...
CLIENT_ID = json.loads(open(os.path.join(PROJECT_ROOT, 'client_secrets.json'),
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(os.path.join(PROJECT_ROOT, 'client_secrets.json'), scope='')
